...
awk '{if (NR>1){print $1,$2"\t"$7"\t"($3-$7)"\t"$9}}' "${outputFolder}/precision_output.txt"
awk '{if (NR>1){print $1,$2"\t"$7"\t"($3-$7)"\t"$9}}' "${outputFolder}/precision_output.txt" >> "${outputFolder}/output.txt"

##sensitivity
echo -e "Measurement\tType\tTP\tFN\tTP/TP+FN"
echo -e "Measurement\tType\tTP\tFN\tTP/TP+FN" >> "${outputFolder}/output.txt"

awk '{if (NR>1){print $1,$2"\t"$7"\t"($3-$7)"\t"$9}}' "${outputFolder}/sensitivity_output.txt"
awk '{if (NR>1){print $1,$2"\t"$7"\t"($3-$7)"\t"$9}}' "${outputFolder}/sensitivity_output.txt" >> "${outputFolder}/output.txt"
