...
## DUPLICATES ARE JUST COPIED, running the pseudo_vcf script will error on the duplicates, just remove it from the diagnostic cluster and rerun script till success
