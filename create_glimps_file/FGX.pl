...
if (defined($dropsence) && defined($UGT1A1) && !defined($iplex)){
	...
	##TODO: wat als waarde niet bestaat?
...
print <<EOF;
#########################################################################################################
# This script takes 4 csv's format and creates one for a specific run in                                #
#                                                                                                       #
#########################################################################################################
Usage: FGX.pl [options]
Options:
